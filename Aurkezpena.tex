...
\end{equation}
\begin{itemize}
 \item This Hamiltonian can be solved exactly.
...
\end{equation}
\begin{itemize}
\item We take a harmonic trial density matrix $\rho_{\mathcal{H}}\equiv\rho_{\mathcal{H}}(\boldsymbol{\Phi},\boldsymbol{\mathcal{R}})$. Variables $\boldsymbol{\Phi}$ (SCHA/auxiliary phonons).
...
\vspace{-0.5cm}
\begin{center}
\includegraphics[width=0.85\linewidth]{Pictures/THEORY/transition.eps}
\end{center}
...
% HERE THERE MUST BE A SLIDE EXPLAINING THE SMA FOR LATTICE THERMAL CONDUCTIVITY
